...
CREATE TABLE IF NOT EXISTS `etat_rapport` (
  `ETAT_CODE` int(20) NOT NULL,
  `ETAT_LIB` varchar(255) NOT NULL,
...
INSERT INTO `etat_rapport` (`ETAT_CODE`, `ETAT_LIB`) VALUES
...
CREATE TABLE IF NOT EXISTS `interagir` (
  `MED_DEP_PERTURBATEUR` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `MED_DEP_PERTURBE` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  PRIMARY KEY (`MED_DEP_PERTURBATEUR`,`MED_DEP_PERTURBE`),
  KEY `medicament_interagir_0FK` (`MED_DEP_PERTURBE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
INSERT INTO `interagir` (`MED_DEP_PERTURBATEUR`, `MED_DEP_PERTURBE`) VALUES
('3MYC7', 'CARTION6'),
('3MYC7', 'DEPRIL9'),
('CLAZER6', 'JOVAI8'),
('BACTIG10', 'POMDI20'),
...
CREATE TABLE IF NOT EXISTS `motif` (
  `MOT_CODE` int(20) NOT NULL,
  `MOT_LIB` varchar(255) NOT NULL,
...
INSERT INTO `motif` (`MOT_CODE`, `MOT_LIB`) VALUES
(1, 'Periodicité'),
...
CREATE TABLE IF NOT EXISTS `offrir` (
  ...
  KEY `offrir_rapport_visite1` (`COL_MATRICULE`,`RAP_NUM`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
CREATE TABLE IF NOT EXISTS `prescrire` (
  ...
  KEY `prescrire_dosage0_FK` (`DOS_CODE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
INSERT INTO `prescrire` (`MED_DEPOTLEGAL`, `TIN_CODE`, `DOS_CODE`) VALUES
('ADIMOL9', 1, 1);
...
CREATE TABLE IF NOT EXISTS `rapport_visite` (
  ...
  `RAP_COUT` float DEFAULT NULL,
  `RAP_DATESAISIE` date NOT NULL,
  `ETAT_CODE` int(20) NOT NULL,
  `MOT_CODE` int(20) DEFAULT NULL,
  `PRA_NUM` int(11) NOT NULL,
  `PRA_NUM_REMP` int(11) DEFAULT NULL,
  `MED_DEPOTLEGAL_PRES1` varchar(10) DEFAULT NULL,
  `MED_DEPOTLEGAL_PRES2` varchar(10) DEFAULT NULL,
  PRIMARY KEY (`COL_MATRICULE`,`RAP_NUM`) USING BTREE,
  KEY `rapport_visite_praticien2_FK` (`PRA_NUM`),
  KEY `rapport_visite_motif0_FK` (`MOT_CODE`),
  KEY `rapport_visite_etat0_FK` (`ETAT_CODE`),
  KEY `rapport_visite_medicament0_FK` (`MED_DEPOTLEGAL_PRES1`),
  KEY `rapport_visite_medicament1_FK` (`MED_DEPOTLEGAL_PRES2`),
  KEY `rapport_visite_praticien_remp0_FK` (`PRA_NUM_REMP`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
ALTER TABLE `interagir`
  ADD CONSTRAINT `medicament_interagir_0FK` FOREIGN KEY (`MED_DEP_PERTURBE`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
  ADD CONSTRAINT `medicament_interagir_1FK` FOREIGN KEY (`MED_DEP_PERTURBATEUR`) REFERENCES `medicament` (`MED_DEPOTLEGAL`);
...
ALTER TABLE `offrir`
  ...
  ADD CONSTRAINT `offrir_rapport_visite1` FOREIGN KEY (`COL_MATRICULE`,`RAP_NUM`) REFERENCES `rapport_visite` (`COL_MATRICULE`, `RAP_NUM`);
...
ALTER TABLE `prescrire`
  ADD CONSTRAINT `prescrire_dosage0_FK` FOREIGN KEY (`DOS_CODE`) REFERENCES `dosage` (`DOS_CODE`),
...
ALTER TABLE `rapport_visite`
  ...
  ADD CONSTRAINT `rapport_visite_etat0_FK` FOREIGN KEY (`ETAT_CODE`) REFERENCES `etat_rapport` (`ETAT_CODE`),
  ADD CONSTRAINT `rapport_visite_medicament0_FK` FOREIGN KEY (`MED_DEPOTLEGAL_PRES1`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
  ADD CONSTRAINT `rapport_visite_medicament1_FK` FOREIGN KEY (`MED_DEPOTLEGAL_PRES2`) REFERENCES `medicament` (`MED_DEPOTLEGAL`),
  ADD CONSTRAINT `rapport_visite_motif0_FK` FOREIGN KEY (`MOT_CODE`) REFERENCES `motif` (`MOT_CODE`),
  ADD CONSTRAINT `rapport_visite_praticien_0FK` FOREIGN KEY (`PRA_NUM`) REFERENCES `praticien` (`PRA_NUM`),
  ADD CONSTRAINT `rapport_visite_praticien_remp0_FK` FOREIGN KEY (`PRA_NUM_REMP`) REFERENCES `praticien` (`PRA_NUM`);
