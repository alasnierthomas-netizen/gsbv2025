<section class="bg-light">
    <div class="container">
        <div class="structure-hero pt-lg-5 pt-4">
            <h1 class="titre text-center">Informations sur le praticien <span class="carac"><?php echo $carac[1]; ?></span></h1>
        </div>
        <div class="row align-items-center justify-content-center">
            ...
            <div class="test col-12 col-sm-8 col-lg-6 col-xl-5 col-xxl-4 py-lg-5 py-3">
                <div class="formulaire">
                    ...
                    <p><span class="carac">Nom</span> : <?php echo $carac[2] ?></p>
                    ...
                    <p><span class="carac">Coefficiant de confiance</span> : <?php echo $carac[6] ?></p>
                     <p><span class="carac">TYP CODE</span> : <?php echo $carac[7] ?></p>
