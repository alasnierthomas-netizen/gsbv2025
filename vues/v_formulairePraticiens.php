    ...
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="test col-12 col-sm-8 col-lg-6 col-xl-5 col-xxl-4 py-lg-5 py-3">
                ...
                <form action="index.php?uc=praticiens&action=afficherpraticiens" method="post" class="formulaire-recherche col-12 m-0">
                    <label class="titre-formulaire" for="listepraticiens">Praticien disponible :</label>
                    <select required name="praticiens" class="form-select mt-3">
